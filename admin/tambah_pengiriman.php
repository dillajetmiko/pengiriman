  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3><i class="fas fa-plus"></i> Tambah Pengiriman</h3>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="Pengiriman.php">Data Pengiriman</a></li>
    ...
    <section class="content">
			<div class="card card-info">
				<div class="card-header">
					<h3 class="card-title"style="margin-top:5px;"><i class="far fa-list-alt"></i> Form Tambah Data Pengiriman</h3>
				...
				<form class="form-horizontal" method="post" enctype="multipart/form-data" action="simpan_pengiriman.php">
				<div class="card-body">
					...
					<div class="form-group row">
						...
						<select class="form-control" name="id_pembayaran">
							<option>-Pilih ID Pembayaran-</option>
							<?php
							$ambil2 = mysqli_query($koneksi, "SELECT * FROM pembayaran");
							while($data2 = mysqli_fetch_assoc($ambil2)){
							?>
									<option value="<?php echo $data2['id_pembayaran'] ?>"><?php echo $data2['id_pembayaran']?></option>';
							<?php
							}
							?>
						</select>
